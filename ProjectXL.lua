...
--// Imports
local imgui = loadstring(game:HttpGetAsync('https://raw.githubusercontent.com/shiinanguyen12/Project-XL-remake.lua/master/UI.lua'))()

--// Declarations 
local quests = {strings={},values={}}
local bosses = loadstring(game:HttpGetAsync('https://raw.githubusercontent.com/shiinanguyen12/Project-XL-remake.lua/master/Bosses.lua'))()
local toolCache = {}
